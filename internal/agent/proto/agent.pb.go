...
func (x *ClientMessage) GetDockerList() *DockerListResponse {
	if x != nil {
		if x, ok := x.Payload.(*ClientMessage_DockerList); ok {
			return x.DockerList
		}
	}
	return nil
...
type ClientMessage_DockerList struct {
	DockerList *DockerListResponse `protobuf:"bytes,10,opt,name=docker_list,json=dockerList,proto3,oneof"`
}
...
func (*ClientMessage_DockerList) isClientMessage_Payload() {}
...
type ServerMessage struct {
	...
	//	*ServerMessage_DockerListRequest
...
func (x *ServerMessage) GetDockerListRequest() *DockerListRequest {
	if x != nil {
		if x, ok := x.Payload.(*ServerMessage_DockerListRequest); ok {
			return x.DockerListRequest
		}
	}
	return nil
}
...
type ServerMessage_DockerListRequest struct {
	DockerListRequest *DockerListRequest `protobuf:"bytes,10,opt,name=docker_list_request,json=dockerListRequest,proto3,oneof"`
}
...
func (*ServerMessage_DockerListRequest) isServerMessage_Payload() {}
...
type DockerListRequest struct {
	state     protoimpl.MessageState `protogen:"open.v1"`
	RequestId string                 `protobuf:"bytes,1,opt,name=request_id,json=requestId,proto3" json:"request_id,omitempty"`
	// kind selects the resource to list. Empty or "containers" → containers;
	// "images" → images; "networks" → networks; "volumes" → volumes.
	Kind string `protobuf:"bytes,2,opt,name=kind,proto3" json:"kind,omitempty"`
	// all (containers only): include stopped containers.
	All           bool `protobuf:"varint,3,opt,name=all,proto3" json:"all,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *DockerListRequest) Reset() {
	*x = DockerListRequest{}
...
func (x *DockerListRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DockerListRequest) ProtoMessage() {}

func (x *DockerListRequest) ProtoReflect() protoreflect.Message {
	mi := &file_internal_agent_proto_agent_proto_msgTypes[31]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DockerListRequest.ProtoReflect.Descriptor instead.
func (*DockerListRequest) Descriptor() ([]byte, []int) {
	return file_internal_agent_proto_agent_proto_rawDescGZIP(), []int{31}
}

func (x *DockerListRequest) GetRequestId() string {
	if x != nil {
		return x.RequestId
	}
	return ""
...
func (x *DockerListRequest) GetKind() string {
	if x != nil {
		return x.Kind
	}
	return ""
...
func (x *DockerListRequest) GetAll() bool {
	if x != nil {
		return x.All
	}
	return false
...
type DockerListResponse struct {
	state     protoimpl.MessageState `protogen:"open.v1"`
	RequestId string                 `protobuf:"bytes,1,opt,name=request_id,json=requestId,proto3" json:"request_id,omitempty"`
	// kind mirrors the request, so the server can route by name.
	Kind string `protobuf:"bytes,2,opt,name=kind,proto3" json:"kind,omitempty"`
	// raw_json carries the Engine REST JSON payload (containers/json, images/json,
	// networks, volumes). The server parses on its side; the agent stays a thin
	// proxy. Keeping the wire payload as JSON avoids rebroadcasting the Engine
	// schema as protobufs and lets newer Engine fields pass through untouched.
...
func (x *DockerListResponse) Reset() {
	*x = DockerListResponse{}
	mi := &file_internal_agent_proto_agent_proto_msgTypes[32]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DockerListResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DockerListResponse) ProtoMessage() {}

func (x *DockerListResponse) ProtoReflect() protoreflect.Message {
	mi := &file_internal_agent_proto_agent_proto_msgTypes[32]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DockerListResponse.ProtoReflect.Descriptor instead.
func (*DockerListResponse) Descriptor() ([]byte, []int) {
	return file_internal_agent_proto_agent_proto_rawDescGZIP(), []int{32}
}

func (x *DockerListResponse) GetRequestId() string {
	if x != nil {
		return x.RequestId
	}
	return ""
...
func (x *DockerListResponse) GetKind() string {
	if x != nil {
		return x.Kind
	}
	return ""
...
func (x *DockerListResponse) GetRawJson() string {
	if x != nil {
		return x.RawJson
	}
	return ""
...
func (x *DockerListResponse) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
const file_internal_agent_proto_agent_proto_rawDesc = "" +
	...
	"\x06closed\x18\x03 \x01(\bR\x06closed\"\x8a\x04\n" +
	...
	"\tfile_info\x18\t \x01(\v2\x17.agent.FileInfoResponseH\x00R\bfileInfo\x12<\n" +
	"\vdocker_list\x18\n" +
	" \x01(\v2\x19.agent.DockerListResponseH\x00R\n" +
	"dockerListB\t\n" +
	"\apayload\"\x95\x05\n" +
	"\rServerMessage\x12@\n" +
	...
	"\tpty_start\x18\t \x01(\v2\x0f.agent.PtyStartH\x00R\bptyStart\x12J\n" +
	"\x13docker_list_request\x18\n" +
	" \x01(\v2\x18.agent.DockerListRequestH\x00R\x11dockerListRequestB\t\n" +
	"\apayload\"e\n" +
	"\bPtyStart\x12\x1d\n" +
	"\n" +
	...
	"\x11DockerListRequest\x12\x1d\n" +
	"\n" +
	"request_id\x18\x01 \x01(\tR\trequestId\x12\x12\n" +
	"\x04kind\x18\x02 \x01(\tR\x04kind\x12\x10\n" +
	"\x03all\x18\x03 \x01(\bR\x03all\"x\n" +
	"\x12DockerListResponse\x12\x1d\n" +
	"\n" +
	"request_id\x18\x01 \x01(\tR\trequestId\x12\x12\n" +
	"\x04kind\x18\x02 \x01(\tR\x04kind\x12\x19\n" +
	"\braw_json\x18\x03 \x01(\tR\arawJson\x12\x14\n" +
	"\x05error\x18\x04 \x01(\tR\x05error2\xbe\x02\n" +
	"\fAgentService\x12/\n" +
...
var file_internal_agent_proto_agent_proto_msgTypes = make([]protoimpl.MessageInfo, 33)
var file_internal_agent_proto_agent_proto_goTypes = []any{
	...
	(*DockerListRequest)(nil),   // 31: agent.DockerListRequest
	(*DockerListResponse)(nil),  // 32: agent.DockerListResponse
}
var file_internal_agent_proto_agent_proto_depIdxs = []int32{
	...
	32, // 7: agent.ClientMessage.docker_list:type_name -> agent.DockerListResponse
	17, // 8: agent.ServerMessage.command_request:type_name -> agent.CommandRequest
	20, // 9: agent.ServerMessage.pty_input:type_name -> agent.PtyInput
	21, // 10: agent.ServerMessage.pty_resize:type_name -> agent.PtyResize
	22, // 11: agent.ServerMessage.pty_close:type_name -> agent.PtyClose
	23, // 12: agent.ServerMessage.file_list_request:type_name -> agent.FileListRequest
	26, // 13: agent.ServerMessage.file_upload_request:type_name -> agent.FileUploadRequest
	27, // 14: agent.ServerMessage.file_download_request:type_name -> agent.FileDownloadRequest
	29, // 15: agent.ServerMessage.file_info_request:type_name -> agent.FileInfoRequest
	14, // 16: agent.ServerMessage.pty_start:type_name -> agent.PtyStart
	31, // 17: agent.ServerMessage.docker_list_request:type_name -> agent.DockerListRequest
	25, // 18: agent.FileListResponse.entries:type_name -> agent.FileEntry
	1,  // 19: agent.AgentService.Ping:input_type -> agent.PingRequest
	3,  // 20: agent.AgentService.Exec:input_type -> agent.ExecRequest
	5,  // 21: agent.AgentService.Upload:input_type -> agent.UploadRequest
	7,  // 22: agent.AgentService.Download:input_type -> agent.DownloadRequest
	0,  // 23: agent.AgentService.SystemInfo:input_type -> agent.Empty
	10, // 24: agent.AgentService.PTY:input_type -> agent.PTYRequest
	12, // 25: agent.TunnelService.Connect:input_type -> agent.ClientMessage
	2,  // 26: agent.AgentService.Ping:output_type -> agent.PingResponse
	4,  // 27: agent.AgentService.Exec:output_type -> agent.ExecChunk
	6,  // 28: agent.AgentService.Upload:output_type -> agent.UploadResponse
	8,  // 29: agent.AgentService.Download:output_type -> agent.Chunk
	9,  // 30: agent.AgentService.SystemInfo:output_type -> agent.SystemInfoResponse
	11, // 31: agent.AgentService.PTY:output_type -> agent.PTYChunk
	13, // 32: agent.TunnelService.Connect:output_type -> agent.ServerMessage
...
func file_internal_agent_proto_agent_proto_init() {
	...
	file_internal_agent_proto_agent_proto_msgTypes[13].OneofWrappers = []any{
		...
		(*ServerMessage_DockerListRequest)(nil),
	}
	type x struct{}
